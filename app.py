...
def post3():
    post_dict = {'id': 3,
                ...
                'content2': "So… Meetups.  I have been actively exploring Seattle's tech meetups for three months, since mid-September 2019. I've heard the same advice from several different people, so it's probably worth noting. 'It's better to attend a few groups regularly than to attend many different groups once.' I'd rate this as 95 percent accurate. I follow the spirit of the advice. I am a regular at PuPPy & Data Circles, which is the new name of Seattle Women in Data Science (SeaWiDS). However, I follow 56 tech groups on the Meetup app. I've also been to events hosted by at least 12 of them. Some of the best events I've attended have been by groups that haven't hosted anything else since. I could (and will) write a blog about what factors I think contribute to a 'great' event, but current point is that there are a number of advantages to casting a wide net when looking for events to attend. <br> First, there is great value in choosing which groups to attend regularly from a variety of known options. Reading event descriptions is a good way to learn about events, but experiencing the atmosphere of events hosted a specific group was more important for me. I already knew several active member of the PuPPy community, but I went to Data Circles for the first time without knowing anyone. Two months later, I am now an active volunteer for the Data Circles meetup group, and it is because I was so impressed by the welcoming atmosphere fostered, while still covering complex concepts that made me think, take notes, and ask questions. <br> Second, some groups don't host frequent events, but do a fantastic job whenever they do. I've been to a few events like this, where the hosts were particularly good about chatting tounfamiliar faces. I imagine it's a lot easier to be an enthusiastic facilitator for these eventsif you only have to do it a couple times a year (though perhaps that's just my introversion speaking). <br> Third, most groups have a fairly broad focus. Python, Data Science, Big Data, and so on.  They'll try to offer a variety of content spanning the full scope of their focus. This is a good thing in general, but if you have a few specific interests, it helps to look many groups. One week, I went to two workshops on hyperparameter tuning, and it was great to have back-to-back lessons covering different tools available for the same task. ", 
                'category': "Miscellany",
